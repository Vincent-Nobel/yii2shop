...
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！[<a href="<?=Yii::getAlias('@web')?>/login.html">登录</a>] [<a href="<?=Yii::getAlias('@web')?>/register.html">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="header w990 bc mt15">
    <div class="logo w990">
        <h2 class="fl"><a href="<?=Yii::getAlias('@web')?>/index.html"><img src="<?=Yii::getAlias('@web')?>/images/logo.png" alt="京西商城"></a></h2>
    </div>
</div>
<!-- 页面头部 end -->
...
<!--            <form action="" method="post">-->
                <ul>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <span>
                            <input type="checkbox" class="chb"  name="LoginForm[remeber]" /> 保存登录信息
                        </span>
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
<script>
    $('.login_btn').click(function () {
        $.post("/member/login",$("#login_form").serialize(),function (data) {
            //转换为json对象
