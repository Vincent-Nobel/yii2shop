...
<!--            <form action="" name="address_form">-->
            <?php
            $form=\yii\widgets\ActiveForm::begin(['id'=>'login_form']);
            ?>
                <ul>
                    <li>
                        <label for=""><span>*</span>收 货 人：</label>
                        <input type="text" name="Address[username]" class="txt" />
                    </li>
<!--  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
                    <li id="content">
...
<!--  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
                    ...
                    <li>
                        ...
                        <input type="text" name="Address[cell]" class="txt" />
                    </li>
<!--                    <li>-->
<!--                        <label for="">&nbsp;</label>-->
...
<script type="text/javascript">
    ...
    $('.login_btn').click(function () {
        $.post("/member/address",$("#login_form").serialize(),function (data) {
...
//            var json=JSON.parse(data);
            ...
            if(json.status){//登录成功
                ...
                $.each(json,function (i,v) {
                    $.each(v,function (name,errors) {
                        console.debug(name,errors)
                        //找到该对象
                        $('#'+name+'p').text(errors);
                    })
                })
