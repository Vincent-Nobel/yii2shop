...
<div class="mycart w990 mt10 bc">
    ...
    <table>
            ...
            foreach ($models as $model):
                ...
                <tr data-id="<?=$model['id']?>">
                    ...
                    <td class="col4">
                        ...
                        <input type="text" name="amount" value="<?=(int)$carts[$model['id']]?>" class="amount"/>
                        <a href="javascript:;" class="add_num" id="list"></a>
                    </td>
                    <td class="col5">￥<span><?= (int)$model['shop_price']* (int)$carts[$model['id']]?></span></td>
        ...
        <tfoot>
        <tr>
            <td colspan="6">购物金额总计： <strong>￥ <span id="total"><?= (int)$model['shop_price']* (int)$carts[$model['id']]?></span></strong></td>
        </tr>
        </tfoot>
    </table>
    <div class="cart_btn w990 bc mt10">
        <a href="" class="continue">继续购物</a>
        <a href="/order/chec" class="checkout">结 算</a>
    </div>
</div>
<!-- 主体部分 end -->
