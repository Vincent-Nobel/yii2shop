    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                ?>
                <div class="cat item1">
                    <h3><a href="list?id=<?=$category->id?>"><?=$category->name?></a> <b></b></h3>
                    <div class="cat_detail">
                        <?php
                        $children=$category->children(1)->orderby('tree')->all();
                        foreach ($children as $child):
                        ?>
                        <dl class="dl_1st">
                            <dt><a href="list?id=<?=$child->id?>"><?=$child->name?></a></dt>
                            <?php
                            $chil=$child->children()->all();
                            foreach ($chil as $chid):
                            ?>
                            <dd>
                                <a href="list?id=<?=$chid->id?>"><?=$chid->name?></a>
                            </dd>
                                <?php
                                endforeach;
                                ?>
