    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    ...
                    <a href="<?=$good->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$good->logo?>" alt="" width="350px" height="350px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                    <?php
                    endforeach;
                    ?>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            ?>
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$item->path?>',largeimage: '<?=$item->path?>'}"><img src="<?=$item->path?>">
                                </a>
                            </li>
                            <?php endforeach;?>
                        </ul>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['cart/add-to-cart','goods_id'=>$goods_id])?>" method="POST" class="choose">
                    <ul>
                        <li>
                            <dl>
                                <dt>购买数量：</dt>
